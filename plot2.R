...
plot2 <- function(genPNG=TRUE) {
    ...
    ## Draw Plot
    with(raw.data, plot(Time, Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)"))
